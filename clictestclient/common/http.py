...
USER_AGENT = 'python-clictestclient'
...
class _BaseHTTPClient(object):
    ...
    def _handle_response(self, resp):
        ...
        # Read body into string if it isn't obviously test data
        if content_type == 'application/octet-stream':
            # Do not read all response in memory when downloading an test.
...
class SessionClient(adapter.Adapter, _BaseHTTPClient):
    ...
    def __init__(self, session, **kwargs):
        ...
        kwargs.setdefault('service_type', 'test')
